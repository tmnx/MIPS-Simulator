...
/**
 * The Branch if Not Equal instruction and its execution.
 * 
 * @author tmn1014
 * @version 03 November 2019
 */

public class BranchNE extends IFormat {
	
	/** The label to be branched to. */
	private String myLabel;
	
	public BranchNE(final String theOpcode, final String theRt,
	...
	/**
	 * Execute the branch if not equal instruction.
	 * 
	...
	public void execute(Computer theComp) {
		...
		if (rsValue != rtValue) {									// if not equal, branch to label
